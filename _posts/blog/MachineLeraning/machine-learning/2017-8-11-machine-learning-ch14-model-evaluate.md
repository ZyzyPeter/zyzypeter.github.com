...
![](\images\blog\ml14-38.png)

可以将这k个测试错误率看作泛化错误率$$\epsilon_0$$的独立采样，则变量

![](\images\blog\ml14-39.png)

服从自由度为 k-1 的t分布，如图：

![](\images\blog\ml14-40.png)
