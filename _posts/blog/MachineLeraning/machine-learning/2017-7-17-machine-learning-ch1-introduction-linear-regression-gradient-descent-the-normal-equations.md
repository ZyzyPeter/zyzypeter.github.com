...
![](\images\blog\supervise-learning-sample-problem.png)
...
![](\images\blog\ml1-11.png)

其实就是根据复合函数的求导法则与链式求导法则进行推导的。

![](\images\blog\ml1-14.jpg)
