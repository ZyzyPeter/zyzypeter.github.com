...
![](\images\blog\ml10-8.png)

所以我们可以取映射

![](\images\blog\ml10-9.png)

易得$$Φ(x)·Φ(z)=(xz)^2=K(x,z)$$

* 若是取$$H=R^3$$以及映射

![](\images\blog\ml10-10.png)

我们也可以得到一个核函数$$Φ(x)·Φ(z)=(xz)^2=K(x,z)$$

* 另外，还可以取$$H=R^4$$与映射

![](\images\blog\ml10-11.png)
...
![](\images\blog\ml10-14.png)


根据这个映射，对任意的$$x_i∈X，α_i∈R,i=1,...,m$$
，定义线性组合

![](\images\blog\ml10-15.png)
...
![](\images\blog\ml10-28.png)

则

![](\images\blog\ml10-29.png)
...
![](\images\blog\ml10-31.png)

和

![](\images\blog\ml10-32.png)
...
![](\images\blog\ml10-34.png)

因此，对任意$$x_1,...,x_m$$，构造$$K(x,z)$$关于这一族向量的Gram矩阵

![](\images\blog\ml10-35.png)

而对任意$$c_1,...,c_m∈R$$（这里c显然是标量），有

![](\images\blog\ml10-36.png)
...
![](\images\blog\ml10-42.png)

### 高斯函数

Gaussian kernel function

![](\images\blog\ml10-43.png)

对应**高斯径向基函数分类器**（radial basis function），分类决策函数：

![](\images\blog\ml10-44.png)
