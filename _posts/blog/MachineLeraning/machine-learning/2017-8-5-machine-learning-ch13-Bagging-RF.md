...
![](\images\blog\ml13-9.png)

即若某类标记得票数超过半数，则预测为该类别，否则拒绝预测。

* 相对多数投票法（plurality voting）

![](\images\blog\ml13-10.png)
