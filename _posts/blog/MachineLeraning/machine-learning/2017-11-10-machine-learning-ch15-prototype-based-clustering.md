...
![](\images\blog\ml15-4.png)

* FM 指数 （Fowlkes and Mallows Index , FMI）

![](\images\blog\ml15-5.png)

* Rand 指数 （Rand Index, RI）

![](\images\blog\ml15-6.png)
...
![](\images\blog\ml15-8.png)

* Dunn 指数 （Dunn Index, DI）

![](\images\blog\ml15-9.png)
...
![](\images\blog\ml15-10.png)

![](\images\blog\ml15-11.png)

直递性又称“三角不等式”

给定样本$$$x_i=(x_{i1};...;x_{in}),x_j=(x_{j1};...;x_{jn})$$$，最常用的是**闵可夫斯基距离（Minkowski distance）**

![](\images\blog\ml15-12.png)
