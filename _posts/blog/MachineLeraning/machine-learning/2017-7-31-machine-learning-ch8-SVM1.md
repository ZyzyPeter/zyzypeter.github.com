...
![](\images\blog\ml8-13.png)

又因为

![](\images\blog\ml8-14.png)
...
![](\images\blog\ml8-17.png)

根据最大间隔算法，我们构造最优化问题为：

![](\images\blog\ml8-18.png)
...
![](\images\blog\ml8-24.png)

所以，如果考虑极小化问题

![](\images\blog\ml8-25.png)
...
![](\images\blog\ml8-37.png)

![](\images\blog\ml8-38.png)
...
![](\images\blog\ml8-55.png)

并选择$$α^*$$的一个正分量$$α^*_j > 0$$计算

![](\images\blog\ml8-56.png)

3.求得分离超平面

![](\images\blog\ml8-57.png)

分类决策函数：

![](\images\blog\ml8-58.png)
...
![](\images\blog\ml8-59.png)

对应于$$α^*_i > 0$$的实例$$x_i$$，有

![](\images\blog\ml8-60.png)
