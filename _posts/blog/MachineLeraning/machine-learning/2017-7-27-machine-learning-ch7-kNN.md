...
![](\images\blog\ml7-10.png)

我们藉构造的kd树的二维空间图形表示就是：

![](\images\blog\ml7-11.png)

树形表示则是：

![](\images\blog\ml7-13.png)
